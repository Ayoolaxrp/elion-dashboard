// Apply supabase/migrations/024_client_portal.sql to the live project.
const fs = require("fs");
...
const sql = fs.readFileSync(path.join(__dirname, "..", "supabase", "migrations", "024_client_portal.sql"), "utf8");
...
async function run() {
  ...
  console.log("OK migration 024 applied.");
