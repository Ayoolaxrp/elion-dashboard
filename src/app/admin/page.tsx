  ...
  return (
    <div className="max-w-5xl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
        ...
        <Link href="/admin/onboarding" className="p-5 rounded-xl bg-[var(--color-surface-raised)] border border-[var(--color-border)] hover:border-[var(--color-accent)]/30 transition-colors group"><div className="flex items-center justify-between mb-3"><Zap className="w-5 h-5 text-[var(--color-text-muted)] group-hover:text-[var(--color-accent)]" /><ArrowRight className="w-4 h-4 text-[var(--color-text-muted)]" /></div><h3 className="text-sm font-medium text-[var(--color-text-primary)] mb-1">Onboarding</h3><p className="text-xs text-[var(--color-text-muted)]">Client pipelines</p></Link><Link href="/admin/status" className="p-5 rounded-xl bg-[var(--color-surface-raised)] border border-[var(--color-border)] hover:border-[var(--color-accent)]/30 transition-colors group"><div className="flex items-center justify-between mb-3"><CheckCircle className="w-5 h-5 text-[var(--color-text-muted)] group-hover:text-[var(--color-accent)]" /><ArrowRight className="w-4 h-4 text-[var(--color-text-muted)]" /></div><h3 className="text-sm font-medium text-[var(--color-text-primary)] mb-1">Status</h3><p className="text-xs text-[var(--color-text-muted)]">Manage status page</p></Link>
      </div>
