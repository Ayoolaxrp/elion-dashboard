...
export default function FunnelPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-surface)]">      <header className="sticky top-0 z-50 bg-[var(--color-surface)]/80 backdrop-blur-xl border-b border-[var(--color-border)]/50">
      ...
      </section>      <section id="method" className="py-12 sm:py-20 px-4 sm:px-6 bg-[var(--color-surface-raised)]">
        <div className="max-w-4xl mx-auto">
...
<section className="py-12 sm:py-20 px-4 sm:px-6 bg-[var(--color-surface-raised)]"><div className="max-w-3xl mx-auto text-center"><h2 className="text-2xl sm:text-3xl font-bold text-[var(--color-text-primary)] mb-6">Clear pricing. No surprises.</h2><p className="text-lg text-[var(--color-text-secondary)] leading-relaxed">Automation projects are scoped around your actual workflow. After the audit and discovery conversation, we recommend the implementation that fits the problem with a clear scope and price before work begins.</p></div></section>
