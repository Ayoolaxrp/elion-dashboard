    ...
    <div className="min-h-screen bg-[var(--color-surface-raised)]">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight leading-tight mb-6">
            Turn enquiries into<br /><span className="text-[var(--color-text-primary)]">booked appointments.</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 pt-8 border-t border-[var(--color-border)]">
            {[{v:"Auto",l:"Booking flow"},{v:"Reduced",l:"No-show rate"},{v:"Confirmed",l:"Auto-reminders"},{v:"Auto",l:"Reminders"}].map(s=><div key={s.l} className="text-center"><p className="text-2xl font-bold text-white">{s.v}</p><p className="text-xs text-[var(--color-text-muted)] mt-1">{s.l}</p></div>)}
          </div>
        </div>
      </section>
      ...
      <section id="cta" className="py-20 px-6 border-t border-[var(--color-border)]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-[var(--color-text-muted)] mb-8">Get a free booking audit. We will show you where the gaps are.</p>
