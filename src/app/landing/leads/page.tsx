    ...
    <div className="min-h-screen bg-[var(--color-surface-raised)]">
      ...
      <section className="border-b border-[var(--color-border)]">
        <div className="max-w-4xl mx-auto px-6 py-16 md:py-24 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-[var(--color-accent)]/10 border border-[var(--color-accent)]/30 text-[var(--color-accent)] text-xs font-semibold mb-6 uppercase tracking-wider">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 pt-6 border-t border-[var(--color-border)]">
            {[{ v: "<3s", l: "Response time" }, { v: "Instant", l: "WhatsApp reply" }, { v: "24/7", l: "Always on" }].map((s) => (
              <div key={s.l} className="text-center">
                <p className="text-2xl font-bold text-[var(--color-text-primary)]">{s.v}</p>
                <p className="text-xs text-[var(--color-text-muted)] mt-1">{s.l}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="border-b border-[var(--color-border)] bg-[var(--color-surface)]">
        <div className="max-w-4xl mx-auto px-6 py-16">
          <h2 className="text-2xl font-bold text-[var(--color-text-primary)] text-center mb-8">The problem</h2>
          <div className="max-w-2xl mx-auto space-y-4">
            {[
              ...
              <div key={i} className="flex items-start gap-3 bg-[var(--color-surface-raised)] border border-[var(--color-border)] rounded-lg p-4">
                <div className="w-6 h-6 rounded bg-[var(--color-error)]/10 flex items-center justify-center shrink-0 mt-0.5">
                  <span className="text-xs font-bold text-[var(--color-error)]">{i + 1}</span>
                </div>
                <p className="text-sm text-[var(--color-text-secondary)]">{p}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="border-b border-[var(--color-border)]">
        <div className="max-w-4xl mx-auto px-6 py-16">
          <h2 className="text-2xl font-bold text-[var(--color-text-primary)] text-center mb-8">What ELION does</h2>
      ...
      <section className="border-b border-[var(--color-border)] bg-[var(--color-surface)]">
        <div className="max-w-4xl mx-auto px-6 py-16">
          <h2 className="text-2xl font-bold text-[var(--color-text-primary)] text-center mb-8">What is included</h2>
          <div className="grid md:grid-cols-2 gap-3 max-w-3xl mx-auto">
            {[
              ...
              <div key={f} className="flex items-center gap-2 p-3 rounded-lg bg-[var(--color-surface-raised)] border border-[var(--color-border)]">
      ...
      <section id="cta">
        <div className="max-w-2xl mx-auto px-6 py-16 text-center">
          <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-3">Ready to stop losing leads?</h2>
          <p className="text-sm text-[var(--color-text-muted)] mb-8">Get your free lead response audit. We will show you exactly how many leads you are losing.</p>
          ...
          <p className="mt-4 text-xs text-[var(--color-text-muted)]">No credit card required. Free audit.</p>
        </div>
      </section>
    </div>
  );
