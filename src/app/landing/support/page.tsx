    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="border-b border-zinc-200">
        <div className="max-w-5xl mx-auto px-6 py-16">
          <h2 className="text-xl font-bold text-zinc-900 mb-8">Contact us</h2>
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <h3 className="text-sm font-semibold text-zinc-900 mb-1">WhatsApp</h3>
              <p className="text-xs text-zinc-500 mb-2">Fastest response. Available during business hours.</p>
              <p className="text-xs text-zinc-400">+234 801 234 5678</p>
            </a>
            ...
            <div className="border border-zinc-200 rounded-lg p-5">
              <div className="w-10 h-10 rounded-lg bg-zinc-100 flex items-center justify-center text-zinc-600 mb-3">
                <Phone className="w-5 h-5" />
              </div>
              <h3 className="text-sm font-semibold text-zinc-900 mb-1">Phone</h3>
              <p className="text-xs text-zinc-500 mb-2">Monday to Friday, 9am to 6pm WAT.</p>
              <p className="text-xs text-zinc-400">+234 801 234 5678</p>
            </div>
          </div>
      ...
      <section className="border-b border-zinc-200 bg-zinc-50">
        <div className="max-w-2xl mx-auto px-6 py-16">
          <h2 className="text-xl font-bold text-zinc-900 mb-2">Send a support request</h2>
          <p className="text-sm text-zinc-500 mb-8">Fill out the form below and we will get back to you within 24 hours.</p>

          {submitted ? (
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-6 text-center">
              <CheckCircle className="w-8 h-8 text-emerald-600 mx-auto mb-3" />
              <h3 className="text-base font-semibold text-zinc-900 mb-1">Request submitted</h3>
              <p className="text-sm text-zinc-500">We will respond within 24 hours. For urgent issues, contact us via WhatsApp.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="bg-white border border-zinc-200 rounded-lg p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-semibold text-zinc-600 block mb-1">Name</label>
                  <input
                    type="text"
                    required
                    value={form.name}
              ...
              <div>
                <label className="text-xs font-semibold text-zinc-600 block mb-1">Message</label>
                <textarea
                  required
                  rows={4}
                  value={form.message}
                  onChange={(e) => setForm({ ...form, message: e.target.value })}
                  className="w-full px-3 py-2 bg-white border border-zinc-200 rounded text-sm text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-900/10 resize-none"
