      ...
      <div className="min-h-screen bg-[var(--color-surface)] flex items-center justify-center p-4">
        <div className="w-full max-w-sm text-center">
          ...
          <div className="p-4 rounded-xl bg-[var(--color-surface-raised)] border border-[var(--color-border)]">
            <p className="text-xs text-[var(--color-text-secondary)]">Set <code className="text-[var(--color-accent)]">NEXT_PUBLIC_SUPABASE_URL</code> and <code className="text-[var(--color-accent)]">NEXT_PUBLIC_SUPABASE_ANON_KEY</code> in your environment variables to enable login.</p>
          </div>
