...
import {
  ...
  RotateCcw, Settings, Activity, ChevronDown, Circle, CircleDot,
  PlayCircle, Users, Layers, ServerCog,
} from "lucide-react";
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="flex items-center gap-3">
                <span className="text-[11px] font-bold text-[var(--color-accent-bright)] uppercase tracking-wider">
